...
use crate::audio::player::{
    LivePlaybackConfig, OutputMode, Player, PlayerSnapshot, StreamQueueItem, TrackTags,
};
...
struct AgentRuntimeState {
    ...
    engine_prefetched: Option<EnginePrefetchedSource>,
...
fn arm_buffered_front_for_gapless(player: &Player, rt: &mut AgentRuntimeState) {
...
fn synchronize_gapless_engine_advance(
    rt: &mut AgentRuntimeState,
    player_file_name: Option<&str>,
...
mod tests {
    use super::{
        AgentRuntimeState, EnginePrefetchedSource, agent_source_matches_player_file,
        normalize_agent_id, reachable_stream_base_url, synchronize_gapless_engine_advance,
    };
