...
work=$repo/tools/split_phase_v5/work-spe-e2-support-2064-20260719
...
exec nice -n 10 \
  ...
  "$python" -m tools.split_phase_v5.e2_support_refine \
    ...
    --proxy-work-dir "$repo/tools/split_phase_v5/work-spe-e2-audio-local-20260719" \
    --work-dir "$work" \
    --candidate-index 2064 \
    --iterations 16 \
